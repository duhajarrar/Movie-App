...
public class MenuRecycleAdapter extends RecyclerView.Adapter<MenuRecycleAdapter.MenuHolder>  {
    ...
    public MenuRecycleAdapter(Context context, ArrayList<Movies> movies, User user) {
        this.movies = movies;
    ...
    @Override
    public void onBindViewHolder(@NonNull final MenuRecycleAdapter.MenuHolder holder, int position) {
       ...
       // final TextView txtCom = new TextView(context);
        ...
        txtcmt.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) { }
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                map.put("textcom",s.toString()); }
            @Override
        ...
        Comment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MainActivity.dataBaseHelper.addComment(map.get("textcom")+"",movie.getId());
                Log.d("text com",map.get("textcom")+"===add comment");
