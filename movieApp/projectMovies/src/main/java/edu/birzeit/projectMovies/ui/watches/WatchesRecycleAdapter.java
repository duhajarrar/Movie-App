...
import edu.birzeit.projectMovies.ui.watches.WatchesMovieFragment;
...
public class WatchesRecycleAdapter extends RecyclerView.Adapter<WatchesRecycleAdapter.MenuHolder> {

    ArrayList<Movies> movies;
    Context context;
    User user;

    public WatchesRecycleAdapter(Context context, ArrayList<Movies> movies, User user) {
        this.movies = movies;
    ...
    @Override
    public void onBindViewHolder(@NonNull final WatchesRecycleAdapter.MenuHolder holder, int position) {
        ...
        addToWatch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                user.delWatch(movie.getId());
                holder.dateWatch.setText("");
                HomeActivity.dataBaseHelper.updateUser(HomeActivity.user);
                movies=HomeActivity.user.getWatchedMovies();
                MenuRecycleAdapter menuRecycleAdapter = new MenuRecycleAdapter(context, movies, HomeActivity.user);
                WatchesMovieFragment.recyclerView.setAdapter(menuRecycleAdapter);
                WatchesMovieFragment.recyclerView.setLayoutManager(new LinearLayoutManager(context));
                Toast toast = Toast.makeText(context, "removed successfully", Toast.LENGTH_SHORT);
                toast.show();
